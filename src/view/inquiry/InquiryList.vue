...
<div>
  ...
  <div class="container is-fullhd">
    <div class="notification">
      ...
      <form-select
        id="categotry"
        v-model.trim="form.items.categotry.value"
        v-bind:formItem="form.items.categotry"
        label="カテゴリ"
      />
...
const inquiryCategories = store.state.master.inquiryCategories;
const inquiryGenre = store.state.master.inquiryGenre;
